"""
Use local dots.tts-soar to clone a reference voice and synthesize text.

Default output:
samples/v_zh_046_电台主持-低沉_沉稳_沉浸式/dots.tts-soar_${t}_${k}khz.wav
...
MODEL_PATH = Path("/home/muyi086/hf-mirror/rednote-hilab/dots.tts-soar")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Local dots.tts-soar voice clone synthesis")
    parser.add_argument("--model-path", type=Path, default=MODEL_PATH, help="dots.tts-soar model path")
