...
DEFAULT_REPORTS_DIR = PROJECT_ROOT / "longAudioTestV6" / "评测结果"
RESULT_FILE_NAME = "task6_evaluation_results.json"
CER_REPORT_NAME = "SenseVoice_CER&Whisper-large-v3-turbo_CER_V6评价报告.md"
AUTOMATED_REPORT_NAME = "音频交付与文本一致性_V6自动检查报告.md"
...
def main() -> int:
    ...
    try:
        ...
        print(f"Task 6 报告生成失败：{error}", file=sys.stderr)
        return 2
    print(cer_path)
