#!/usr/bin/env python3
"""从 Task 8 V7 原始结果生成单模型、三维度和综合中文评价报告。"""
...
def configure_shared_renderer() -> None:
    """为复用的长音频报告渲染器注入 V7 冻结常量。"""

    shared.REPORT_VERSION = "V7"
    shared.SCHEMA_VERSION = "7.0"
    shared.SOURCE_DISPLAY_PATH = "longAudioTestV7/ai_deal.json"
    shared.CONFIG_DISPLAY_PATH = "tts-bench/config/neutral-evaluation-v7.json"
...
if __name__ == "__main__":
    try:
        ...
        print(f"V7 报告生成失败：{error}", file=sys.stderr)
