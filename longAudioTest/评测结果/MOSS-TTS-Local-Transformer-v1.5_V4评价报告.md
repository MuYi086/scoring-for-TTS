# MOSS-TTS-Local-Transformer-v1.5 V4 独立评价报告
...
| --- | --- | ---: | ---: | --- |
| 全文可懂度 | SenseVoice CER | 0.1176 | 六角色宏平均 0.0204 | 越低越好 |
| 全文可懂度 | Whisper CER | 0.1428 | 六角色宏平均 0.0848 | 越低越好 |
| 角色音色 | WavLM SIM | 0.9486 | 同人分段 0.9796；跨角色 0.7181 | 越高越好 |
| 角色音色 | ECAPA SIM | 0.6400 | 同人分段 0.8011；跨角色 0.4621 | 越高越好 |
| 自然度 | UTMOSv2 | 3.3235 | 六角色宏平均 3.0915 | 越高越好 |
| 自然度 | NISQA-TTS | 3.8704 | 六角色宏平均 4.2231 | 越高越好 |
...
- 音频时长：**1745.25 秒**。
- Whisper 时间戳块：**728** 个；精确对齐 **5218 / 5673** 个规范化字符，对齐率 **0.9198**。
