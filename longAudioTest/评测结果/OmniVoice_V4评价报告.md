...
| --- | --- | ---: | ---: | --- |
| 全文可懂度 | SenseVoice CER | 0.0770 | 六角色宏平均 0.0204 | 越低越好 |
| 全文可懂度 | Whisper CER | 0.1743 | 六角色宏平均 0.0848 | 越低越好 |
| 角色音色 | WavLM SIM | 0.9327 | 同人分段 0.9796；跨角色 0.7181 | 越高越好 |
| 角色音色 | ECAPA SIM | 0.6637 | 同人分段 0.8011；跨角色 0.4621 | 越高越好 |
| 自然度 | UTMOSv2 | 3.4370 | 六角色宏平均 3.0915 | 越高越好 |
| 自然度 | NISQA-TTS | 4.1428 | 六角色宏平均 4.2231 | 越高越好 |
...
- 音频时长：**1755.87 秒**。
- Whisper 时间戳块：**725** 个；精确对齐 **5320 / 5673** 个规范化字符，对齐率 **0.9378**。
