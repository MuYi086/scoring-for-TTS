...
| --- | --- | ---: | ---: | --- |
| 全文可懂度 | SenseVoice CER | 0.0610 | 六角色宏平均 0.0204 | 越低越好 |
| 全文可懂度 | Whisper CER | 0.1282 | 六角色宏平均 0.0848 | 越低越好 |
| 角色音色 | WavLM SIM | 0.9549 | 同人分段 0.9796；跨角色 0.7181 | 越高越好 |
| 角色音色 | ECAPA SIM | 0.6444 | 同人分段 0.8011；跨角色 0.4621 | 越高越好 |
| 自然度 | UTMOSv2 | 3.3503 | 六角色宏平均 3.0915 | 越高越好 |
| 自然度 | NISQA-TTS | 3.8229 | 六角色宏平均 4.2231 | 越高越好 |
...
- 音频时长：**1423.46 秒**。
- Whisper 时间戳块：**680** 个；精确对齐 **5318 / 5673** 个规范化字符，对齐率 **0.9374**。
